...
public class OwnersWebMvcTests {
    ...
    public void testOwners() throws Exception{
        final MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/owners");
        ...
        MatcherAssert.assertThat(modelAndView.getViewName(), Matchers.equalTo("index"));
